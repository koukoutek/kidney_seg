...
def train_non_contrast(config, log_path, logger):
    ...
    train_transforms = Compose([
                            ...
                            Transposed(keys=train_transforms_config['Transposed_im']['keys'], 
                                       indices=train_transforms_config['Transposed_im']['indices']),
                            Transposed(keys=train_transforms_config['Transposed_seg']['keys'], 
                                       indices=train_transforms_config['Transposed_seg']['indices']),
                            WindowindNonContrastCTd(keys=train_transforms_config['WindowindNonContrastCTd']['keys']),
    ...
    val_transforms = Compose([
                            ...
                            Transposed(keys=eval_transforms_config['Transposed_seg']['keys'], 
                                       indices=eval_transforms_config['Transposed_seg']['indices']),
                            WindowindNonContrastCTd(keys=eval_transforms_config['WindowindNonContrastCTd']['keys']), 
